...
#define DPR_CONFIG      DPR_SOLENOID
...
#define ENGINE_STATE_VENT_LOX	(1 << 3)
#define ENGINE_STATE_VENT_FUEL	(1 << 2)
...
typedef struct __attribute__((__packed__)) {
	...
	uint16_t fuel_fls_capa       : 11;
	uint16_t LOX_fls_capa        : 11;
#elif defined FLS_CONFIG && FLS_CONFIG == FLS_DIFF
	uint16_t fuel_fls_diff_bot   : 10;
	uint16_t LOX_fls_diff_bot    : 10;
	...
	uint8_t  fuel_ball_valve_state : 4; //       bbbb              | 0,90     | 10   | °
	uint8_t  LOX_ball_valve_state : 4;  //       bbbb              | 0,90     | 10   | °
#endif /* DPR_CONFIG */
	uint8_t  lpb_voltage  		 : 6;   //        bbb.bbb          | 0,5      | 0.1  | V
    int8_t   lpb_current         : 7;   //       bbbb.bbb          | -4,4     | 0.1  | A
    uint8_t  vout_5v_voltage     : 6;   //        bbb.bbb          | 0,5.5    | 0.1  | V
    uint8_t  vout_5v_current     : 5;   //         bb.bbb          | 0,3      | 0.1  | A
